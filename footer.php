					...
					<div class="container">
						<div class="row">
							...
							<div class="col-md-4 animate-box">
								...
								<ul class="contact-info">
									...
									<li><i class="icon-phone"></i>+ 923156401824</li>
									<li><i class="icon-envelope"></i><a href="#">info@fitnessfuelgym.com</a></li>
						...
						<div class="row copy-right">
							<div class="col-md-6 col-md-offset-3 text-center">
								...
								<p>Copyright 2020 Fitness Fuel Gym <a href="#">Fitness</a>.</p>
							</div>
						</div>
