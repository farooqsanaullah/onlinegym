...
<?php  include 'header.php';   ?>
		...
		<!-- end:fh5co-header -->
						...
						<div class="container">
							<div class="row">
								<div class="col-md-7">
									...
									<p><span>With Body Fuel Gym</span></p>
									<span><a class="btn btn-primary" href="admin/dist/register.html">Start Your Journey</a></span>
								</div>
							</div>
						</div>
					</div>
			...
			<div class="fh5co-parallax" style="background-image: url(images/home-image-3.jfif);"
					...
					<div class="row">
						<div
							...
							<div class="fh5co-intro fh5co-table-cell animate-box">
								...
								<p>Made with love by the fine folks at fitness fuel</p>
							</div>
						</div>
					</div>
				</div>
					...
					<div class="row text-center">
						<div class="col-md-4 col-sm-6">
							<div class="team-section-grid animate-box"
								style="background-image: url(images/trainer-1.jfif);">
						...
						<div class="col-md-4 col-sm-6">
							<div class="team-section-grid animate-box"
								style="background-image: url(images/trainer-2.jfif);">
								<div class="overlay-section">
									<div class="desc">
										<h3>James Smith</h3>
						...
						<div class="col-md-4 col-sm-6">
							<div class="team-section-grid animate-box"
								style="background-image: url(images/trainer-3.jfif);">
								<div class="overlay-section">
									<div class="desc">
										<h3>John Doe</h3>
						...
						<div class="col-md-4 col-sm-6">
							<div class="team-section-grid animate-box"
								style="background-image: url(images/trainer-4.jfif);">
								<div class="overlay-section">
									<div class="desc">
										<h3>John Doe</h3>
										<span>Chief Executive Officer</span>
						...
						<div class="col-md-4 col-sm-6">
							<div class="team-section-grid animate-box"
								style="background-image: url(images/trainer-5.jfif);">
								<div class="overlay-section">
									<div class="desc">
										<h3>John Doe</h3>
										<span>Chief Executive Officer</span>
						...
						<div class="col-md-4 col-sm-6">
							<div class="team-section-grid animate-box"
								style="background-image: url(images/trainer-6.jfif);">
								<div class="overlay-section">
									<div class="desc">
										<h3>John Doe</h3>
										<span>Chief Executive Officer</span>
					...
					<div class="row">
						<div class="col-md-6">
							...
							<div class="col-md-12 col-md-offset-0">
								<div class="fh5co-blog animate-box">
									<div class="inner-post">
										<a href="#"><img class="img-responsive" src="images/home-image.jfif" alt=""></a>
									</div>
									<div class="desc">
							...
							<div class="col-md-12 col-md-offset-0">
								<div class="fh5co-blog animate-box">
									<div class="inner-post">
										<a href="#"><img class="img-responsive" src="images/Trainers.jfif" alt=""></a>
									</div>
									<div class="desc">
										<h3><a href="" #>Starting new session of body building this summer</a></h3>
										<span class="posted_by">Posted by: Admin</span>
